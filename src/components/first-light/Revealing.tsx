...
import axwellHeadliner from "@/assets/axwell7.svg";

const REVEAL_DATE = new Date(2026, 7, 21, 17, 0, 0);
        ...
        <AnimatePresence mode="wait">
          {!isRevealed ? (
            ...
            >
              ...
              <div className="relative w-[400px] h-[400px] md:w-[650px] md:h-[650px] flex items-center justify-center my-8">
                <Image
                  src={axwellHeadliner}
                  alt="Axwell"
                  fill
            ...
            <motion.div
              ...
              className="flex flex-col items-center text-center py-10"
            >
              <h2 className={`font-just text-[50px] md:text-[75px] text-[#0FB6AE] leading-none mb-4 drop-shadow-[0_0_30px_rgba(15,182,174,0.6)]`}>
                Revealing In
              </h2>

              <div className="scale-110 md:scale-[1.4] my-16">
                <EventCountdown targetDate={REVEAL_DATE} onComplete={handleCountdownComplete} />
              </div>
              ...
              <motion.button
                ...
                className={`font-just mt-8 text-sm uppercase hover:scale-105 text-white transition-all cursor-pointer`}
              >
                ← Back to Showdown
              </motion.button>
            </motion.div>
        ...
        {isHovered && !isRevealed && (
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              {/* Text */}
              <span className={`font-just relative z-10 text-black text-center text-xl leading-[0.9] font-medium uppercase drop-shadow-sm`}>
                Reveal <br /> Artist
              </span>
            </div>
          </motion.div>
